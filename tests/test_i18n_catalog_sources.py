...
def test_setup_health_voice_sources_have_catalog_translations() -> None:
    ...
    required = {
        ...
        "Wisp {display_name} apply",
        "Applying {display_name}",
        "Preparing to apply optional speech packages.",
        "{display_name} applied successfully.",
        "{display_name} apply failed.",
        "{display_name} staged install is waiting for Wisp to close.",
        "{display_name} staged install is applying package files.",
        "{display_name} staged install is verifying package files.",
        "{display_name} staged install failed: {message}",
        "{display_name} packages are staged. Click Restart app now to close Wisp and apply them.",
        "{display_name} packages are staged. Click Restart app now to close Wisp, replace locked files, verify the install, and reopen.",
        "{display_name} packages stay staged and will be applied the next time Wisp restarts.",
        "{display_name} installed and model ready: {summary}.",
        "{display_name} package files match this Wisp release.",
        "{display_name} package files do not match this Wisp release: {message}.",
        "starting installer",
        ...
        "Wisp will reinstall Kokoro in its user-writable optional packages folder.\n\n",
        ...
        "Kokoro reinstalled and local voice is ready.",
        ...
        "Kokoro package install failed: {message}",
        "Kokoro package installed, but voice asset preparation failed: {message}",
        "Kokoro package installed; {detail}.",
        ...
        "STT package install failed: {message}",
        "STT package installed, but model download/load failed: {message}",
        "STT package installed; downloading or loading Whisper model {model}.",
