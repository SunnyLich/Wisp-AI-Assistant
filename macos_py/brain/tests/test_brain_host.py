...
Run directly:   python macos_py/brain/tests/test_brain_host.py
Run via pytest: pytest macos_py/brain/tests/test_brain_host.py
"""
...
_BRAIN_DIR = Path(__file__).resolve().parents[1]   # macos_py/brain
